...
public class Main {
    public static void find_employee_name(String[] args) {
        ...
        for (int i = 0; i < employees_no; i++){
            System.out.printf("Enter employee %d name:", i+1);      employees_names[i] = in.next();//problem here when entering names with 2 parts
            System.out.printf("Enter %s  HR ID:", employees_names[i]);      employees_HR_ID[i] = in.nextInt();
        }
